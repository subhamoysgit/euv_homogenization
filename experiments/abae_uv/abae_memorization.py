...
if __name__ == "__main__":
	...
	for m in range(ENSEMBLE_SIZE):
		...
		checkpoint = ModelCheckpoint(OUTPUT_FOLDER + OUTPUT_FILE + str(m+1).zfill(2) +'_'+'{epoch:02d}.h5', monitor=['val_loss','val_mse'], verbose=1, save_weights_only=True, mode='auto', save_freq='epoch')
