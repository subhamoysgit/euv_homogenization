...
if __name__ == "__main__":
	...
	# H, xedges, yedges = np.histogram2d(input_intensity,output_sdev, bins=(20, 20),range = [[0.725, 0.925], [0.0050, 0.0275]])
	# pickle.dump(H.T,open('/d0/models/euv_std.p','wb'))
	...
	plt.show()
	plt.figure()
	plt.plot(0.0050 + np.linspace(0,19,20)*0.0225/19,euv[10,:]/np.sum(euv[10,:]),label='euv')
	plt.plot(0.0050 + np.linspace(0,19,20)*0.0225/19,mag[10,:]/np.sum(mag[10,:]),label='mag')
