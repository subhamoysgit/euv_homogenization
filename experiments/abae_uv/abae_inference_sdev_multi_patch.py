...
OUTPUT_FILE = 'eit_aia_sr_abae_medium_GLOROT_UNIF_last_LAMBDA_SCALED_001_ST_10_'#'eit_aia_sr_big_v17'#'eit_aia_sr_abae_small_LAMBDA_01_VAR_1_'
ANCHOR_PARAMS  = '_GLOROT_UNIF_last_LAMBDA_SCALED_001_ST_10_'
