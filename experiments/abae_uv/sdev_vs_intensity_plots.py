...
if __name__ == "__main__":
	...
	for n in range(3):
		plt.subplot(1,3,n+1)
		plt.plot(xx,dict_prof[f[n],0],label='SD = 1,LAMBDA = 0.01')
		plt.plot(xx,dict_prof[f[n],1],label='SD = 10,LAMBDA = 0.001')
		plt.plot(xx,dict_prof[f[n],2],label='SD = 1,LAMBDA = 0.001')
		plt.xlabel('sd')
		plt.title(dict[f[n]])
		plt.yscale('log')
