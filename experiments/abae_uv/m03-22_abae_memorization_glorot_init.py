...
W_ST_f = 10.0 # variance of the anchor weights
W_LAMBDA_f = 0.001 # Strength of the regularization term for anchor weights
B_ST_f = 10.0 # variance of the anchor biases 
...
OUTPUT_FILE = 'eit_aia_sr_abae_medium_GLOROT_UNIF_last_LAMBDA_SCALED_001_ST_10_'
