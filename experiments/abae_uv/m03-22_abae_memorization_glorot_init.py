...
W_LAMBDA_I = 1.0 # Strength of the regularization term for anchor weights
B_ST_I = 1.0 # variance of the anchor biases 
B_LAMBDA_I = 1.0 # Strength of the regularization term for anchor biases
...
OUTPUT_FILE = 'eit_aia_sr_abae_small_GLOROT_UNIF_LAMBDA_1_ST_1_'
